...
| **Postulate / Axiom** | Asserted, unproven proposition. In Coq: `Axiom`. In Lean: `axiom`. In Idris2 0.8.0: `name = believe_me ()` (the `postulate` keyword was removed). Every estate-wide axiom is tracked in [`AUDIT.adoc`](../../AUDIT.adoc) or [`descriptiles/META.a2ml`](../../.machine_readable/descriptiles/META.a2ml). |
...
| **PMPL-1.0** | Palimpsest-MPL 1.0. *Former* project licence (see the archived [licence audit](../archive/LICENSE-AUDIT-2026-02-05.adoc)); the project licence is **MPL-2.0** — see [`LICENSE`](../../LICENSE). |
...
| **ADR** | Architectural Decision Record. Forward-looking design choice. Recorded in [`descriptiles/META.a2ml`](../../.machine_readable/descriptiles/META.a2ml). |
...
| **descriptiles** | The `.a2ml` machine-readable format under `.machine_readable/descriptiles/`. Successor to the older `.scm` (Guile Scheme) format; the side-by-side `.scm` set was removed by the estate standardization (2026-06). |
