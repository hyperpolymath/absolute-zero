...
:experimental:
:url-github: https://github.com/hyperpolymath/absolute-zero
:url-gitlab: https://gitlab.com/hyperpolymath/absolute-zero
:url-bitbucket: https://bitbucket.org/hyperpolymath/absolute-zero
:url-codeberg: https://codeberg.org/hyperpolymath/absolute-zero

Thermodynamic-inspired optimization and cold-start solutions
...
absolute-zero is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
