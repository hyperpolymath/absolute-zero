...
(define-module (absolute-zero meta)
...
(define architecture-decisions
  '((adr-001
     ...
     (status . "accepted")
     (date . "2025-12-15")
     (context . "**Formal Verification of Certified Null Operations: When Doing Nothing Is Everything**")
...
(define development-practices
  '((code-style
     (languages . ("Agda" "CSS" "Dockerfile" "Elm" "HTML" "Isabelle" "Just" "Lean" "Nickel" "ReScript" "Rocq Prover" "Rust" "SMT" "Scheme" "Shell" "TeX"))
